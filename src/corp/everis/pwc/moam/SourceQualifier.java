...
public class SourceQualifier extends TRANSFORMATION implements ISentence{
	...
	public SourceQualifier(ArrayList<SOURCE> srcs, ArrayList<TARGET> tgts) {
		super();
		this.sources = srcs;
		this.targets = tgts;
	}

	public SourceQualifier(TRANSFORMATION transformation,ArrayList<SOURCE> srcs, ArrayList<TARGET> tgts, ArrayList<CONNECTOR> conns){

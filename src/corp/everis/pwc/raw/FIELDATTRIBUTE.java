...
@XmlType(name = "")
@XmlRootElement(name = "FIELDATTRIBUTE")
public class FIELDATTRIBUTE {
    ...
    public FIELDATTRIBUTE(FIELDATTRIBUTE fieldattribute) {
		super();
		this.name = fieldattribute.name;
		this.value = fieldattribute.value;
	}
	...
	public boolean equals(Object v) {
		...
		if (v instanceof FIELDATTRIBUTE){
			FIELDATTRIBUTE ptr = (FIELDATTRIBUTE) v;
			retVal = true;
